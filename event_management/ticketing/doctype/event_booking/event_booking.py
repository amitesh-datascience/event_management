...
class EventBooking(Document):
	...
	if TYPE_CHECKING:
		from event_management.ticketing.doctype.event_booking_attendee.event_booking_attendee import EventBookingAttendee
	...
	# 	ticket_for_this_booking = frappe.get_all(")
